...
class ColumnDescriptor(object):
    ...
    def __init__(self, name=None, maxVersions=3, compression="NONE", inMemory=False, bloomFilterType="NONE", bloomFilterVectorSize=0, bloomFilterNbHashes=0, blockCacheEnabled=False, timeToLive=-1,):
        self.name = name
